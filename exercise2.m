...
% percentage of samples that will be used for validation
validSize = 0.2;%use 20% dataset for validation
...
% best possible tests
assert(isequal(sort([xTrain; xTest]), sort(meas)))%sort is a sorting function
...
for i=1:length(validSizes)
    ...
    %join function was used to connect the string
